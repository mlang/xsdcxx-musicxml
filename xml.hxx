...
public:
  ...
  lang(const ::xercesc::DOMElement &e, ::xml_schema::flags f = 0,
       ::xml_schema::container *c = nullptr);

  lang(const ::xercesc::DOMAttr &a, ::xml_schema::flags f = 0,
       ::xml_schema::container *c = nullptr);

  lang(const ::std::string &s, const ::xercesc::DOMElement *e,
       ::xml_schema::flags f = 0, ::xml_schema::container *c = nullptr);

  lang(const lang &x, ::xml_schema::flags f = 0,
       ::xml_schema::container *c = nullptr);

  virtual lang *_clone(::xml_schema::flags f = 0,
...
public:
  ...
  space(const ::xercesc::DOMElement &e, ::xml_schema::flags f = 0,
        ::xml_schema::container *c = nullptr);

  space(const ::xercesc::DOMAttr &a, ::xml_schema::flags f = 0,
        ::xml_schema::container *c = nullptr);

  space(const ::std::string &s, const ::xercesc::DOMElement *e,
        ::xml_schema::flags f = 0, ::xml_schema::container *c = nullptr);

  space(const space &x, ::xml_schema::flags f = 0,
        ::xml_schema::container *c = nullptr);

  virtual space *_clone(::xml_schema::flags f = 0,
                        ::xml_schema::container *c = nullptr) const override;

  space &operator=(value v);

  virtual operator value() const { return _xsd_space_convert(); }
...
public:
  ...
  lang_member(const ::xercesc::DOMElement &e, ::xml_schema::flags f = 0,
              ::xml_schema::container *c = nullptr);

  lang_member(const ::xercesc::DOMAttr &a, ::xml_schema::flags f = 0,
              ::xml_schema::container *c = nullptr);

  lang_member(const ::std::string &s, const ::xercesc::DOMElement *e,
              ::xml_schema::flags f = 0, ::xml_schema::container *c = nullptr);

  lang_member(const lang_member &x, ::xml_schema::flags f = 0,
              ::xml_schema::container *c = nullptr);
  ...
  virtual operator value() const { return _xsd_lang_member_convert(); }
